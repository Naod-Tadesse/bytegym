 ...
 *
 * Three refusals, three different next actions — never collapsed into "cannot
 * check in". `suspended` is the one that matters most to keep apart: it looks
 * like the other two from the outside but means the opposite thing, and a
 * shared message would have a receptionist selling a membership to someone the
 * gym has barred.
 *
  ...
  return (
    <div className="flex max-w-xs items-start gap-1.5 text-right text-xs">
      <span className="flex flex-col gap-0.5">
        ...
        {/* The next action, which is the whole reason the reasons are kept
            apart. */}
