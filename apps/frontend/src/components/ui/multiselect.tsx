    ...
    <PopoverTrigger
      render={
        <Button
          ...
          className={cn(
            'flex h-auto min-h-10 w-fit items-center justify-between gap-2 overflow-hidden whitespace-nowrap disabled:cursor-not-allowed data-[placeholder]:text-muted-foreground [&_svg]:pointer-events-none [&_svg]:shrink-0',
            className,
          )}
        />
      }
